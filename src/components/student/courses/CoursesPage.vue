...
import type { IGetCoursesResp, ICourseItem } from '@/types/api'
import { testCoursesAPI } from '@/utils/course-api-test'
import { testCourseAPIConnection } from '@/utils/course-api-connection-test'
